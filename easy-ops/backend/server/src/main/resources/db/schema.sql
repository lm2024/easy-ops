...
ALTER TABLE node_info ADD COLUMN IF NOT EXISTS disk_info TEXT DEFAULT NULL;
ALTER TABLE node_info ADD COLUMN IF NOT EXISTS host_cpu_percent DOUBLE DEFAULT 0;
ALTER TABLE node_info ADD COLUMN IF NOT EXISTS host_memory_percent INT DEFAULT 0;
ALTER TABLE node_info ADD COLUMN IF NOT EXISTS host_disk_percent INT DEFAULT 0;
...
-- 管理员初始化已移至 DataInitializer.java（由 app.admin.default-password 控制）
